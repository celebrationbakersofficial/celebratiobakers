...
// New products from images/Products folder (copied from new products folder)
import NewProduct1 from "./vanilla.jpg"; // Placeholder
import NewProduct2 from "./vanilla.jpg"; // Placeholder
import NewProduct3 from "./vanilla.jpg"; // Placeholder
import NewProduct4 from "./vanilla.jpg"; // Placeholder
import NewProduct5 from "./vanilla.jpg"; // Placeholder
import NewProduct6 from "./vanilla.jpg"; // Placeholder
import NewProduct7 from "./vanilla.jpg"; // Placeholder
import NewProduct8 from "./vanilla.jpg"; // Placeholder
import NewProduct9 from "./vanilla.jpg"; // Placeholder
import NewProduct10 from "./vanilla.jpg"; // Placeholder
import NewProduct11 from "./vanilla.jpg"; // Placeholder
import NewProduct12 from "./vanilla.jpg"; // Placeholder
import NewProduct13 from "./vanilla.jpg"; // Placeholder
import NewProduct14 from "./vanilla.jpg"; // Placeholder
import NewProduct15 from "./vanilla.jpg"; // Placeholder
import NewProduct16 from "./vanilla.jpg"; // Placeholder
import PineappleCakeImg from "./Pineapple cake.jpg";
import StrawberryCakeImg from "./Strawberry cake.jpg";
import ButterscotchCakeImg from "./Butterscotch cake.jpg";
import BlackForestCakeImg from "./Black forest cake.jpg";
import WhiteForestCakeImg from "./White forest cake.jpg";
import ChocolateCakeImg from "./Chocolate cake.jpg";
import PineapplePastryImg from "./Pineapple pastry.jpg";
import StrawberryPastryImg from "./Strawberry pastry.jpg";
import ButterscotchPastryImg from "./Butterscotch pastry.jpg";
import BlueberryPastryImg from "./Blueberry pastry.jpg";
import FruitCocktailPastryImg from "./david-holifield-kPxsqUGneXQ-unsplash (1).jpg"; // Placeholder for Fruit Cocktail Pastry
import PistaPastryImg from "./6260476650458302848.jpg"; // Placeholder for Pista Pastry
import RasmalaiPastryImg from "./Rasmalai cake.jpg"; // Using Rasmalai cake for pastry
import MoosePastryImg from "./truffle  cake.jpg"; // Using truffle cake for moose pastry
import ChocolatePastryImg from "./Chocolate pastry.jpg";
import TrufflePastryImg from "./Truffle pastry.jpg";
import WhiteTrufflePastryImg from "./Whiteforest pastry.jpg";
import BlackForestPastryImg from "./Blackforeat pastry.jpg";
import RegularCelebrationPastryImg from "./david-holifield-kPxsqUGneXQ-unsplash (1).jpg"; // Placeholder
import ChocolateTruffleBrownieImg from "./Hot chocolate brownie.jpg";
import BrownieWithIceCreamImg from "./Brownie with Icecream.jpg";
import CroissantImg from "./nadya-spetnitskaya-tOYiQxF9-Ys-unsplash.jpg";
import DonutImg from "./david-holifield-kPxsqUGneXQ-unsplash (1).jpg"; // Placeholder
import CupcakeVanillaImg from "./Vanilla cupcake.jpg";
import CupcakeChocolateImg from "./Choco cupcake.jpg";
import TruffleCupImg from "./Redvelvet cupcake.jpg"; // Using Redvelvet cupcake for Truffle Cup
import ChocoLavaImg from "./Brownie with Icecream.jpg"; // Using Brownie with Icecream for Choco Lava
import PistaMiniCakeImg from "./6260476650458302848.jpg"; // Placeholder
import BiscoffMiniCakeImg from "./ales-krivec-QnNqGoCnBg0-unsplash.jpg"; // Placeholder
import RedVelvetMiniCakeImg from "./Redvelevet cake.jpg"; // Using Redvelvet cake for mini cake
import LotusBiscoffCheesePastryImg from "./pastry/photo_2025-03-30_10-33-33.jpg";
import BlueberryCheesePastryImg from "./pastry/photo_2025-03-30_10-33-30.jpg";
import MangoCheesePastryImg from "./Mango pastry.jpg";
import HazelnutCheesePastryImg from "./6260476650458302810.jpg"; // Placeholder
import LotusBiscoffCheeseCakeImg from "./cheesecakes/photo_2025-03-30_10-34-06.jpg";
import BlueberryCheeseCakeImg from "./cheesecakes/photo_2025-03-30_10-34-05.jpg";
import MangoCheeseCakeImg from "./cheesecakes/photo_2025-03-30_10-34-05.jpg"; // Placeholder
import HazelnutCheeseCakeImg from "./cheesecakes/photo_2025-03-30_10-34-06.jpg"; // Placeholder
import Bread400gmImg from "./patrick-tomasso-NlcCPeKNmwg-unsplash.jpg";
import Bread600gmImg from "./patrick-tomasso-NlcCPeKNmwg-unsplash.jpg"; // Same as 400gm for now
import JumboBreadImg from "./patrick-tomasso-NlcCPeKNmwg-unsplash.jpg"; // Same as 400gm for now
import PavImg from "./patrick-tomasso-NlcCPeKNmwg-unsplash.jpg"; // Same as 400gm for now
import BurgerBunImg from "./patrick-tomasso-NlcCPeKNmwg-unsplash.jpg"; // Same as 400gm for now
import PavBhajiPavImg from "./patrick-tomasso-NlcCPeKNmwg-unsplash.jpg"; // Same as 400gm for now
import MasalaBunImg from "./patrick-tomasso-NlcCPeKNmwg-unsplash.jpg"; // Same as 400gm for now
import PizzaBaseImg from "./patrick-tomasso-NlcCPeKNmwg-unsplash.jpg"; // Same as 400gm for now
import HotCoffeeImg from "./brooke-lark-pGM4sjt_BdQ-unsplash.jpg"; // Placeholder
import ColdCoffeeImg from "./brooke-lark-pGM4sjt_BdQ-unsplash.jpg"; // Placeholder
import ColdCoffeeIceCreamImg from "./brooke-lark-pGM4sjt_BdQ-unsplash.jpg"; // Placeholder
import ChilliPaneerPattieImg from "./blake-wisz-0mZIT-EcH5k-unsplash.jpg"; // Placeholder
import AlooPattieImg from "./blake-wisz-0mZIT-EcH5k-unsplash.jpg"; // Placeholder
import PaneerRollImg from "./blake-wisz-0mZIT-EcH5k-unsplash.jpg"; // Placeholder
import PaneerKulchaImg from "./blake-wisz-0mZIT-EcH5k-unsplash.jpg"; // Placeholder
import VeggieRollImg from "./blake-wisz-0mZIT-EcH5k-unsplash.jpg"; // Placeholder
import CheeseRollImg from "./blake-wisz-0mZIT-EcH5k-unsplash.jpg"; // Placeholder
import HoneyAlmondCookiesImg from "./angelo-pantazis-2-U0A2tNYhM-unsplash.jpg";
import KajuCookiesImg from "./angelo-pantazis-2-U0A2tNYhM-unsplash.jpg"; // Same as Honey Almond
import BadamCookiesImg from "./angelo-pantazis-2-U0A2tNYhM-unsplash.jpg"; // Same as Honey Almond
import JimJamCookiesImg from "./angelo-pantazis-2-U0A2tNYhM-unsplash.jpg"; // Same as Honey Almond
import NataKataCookiesImg from "./angelo-pantazis-2-U0A2tNYhM-unsplash.jpg"; // Same as Honey Almond
import JeeraCookiesImg from "./angelo-pantazis-2-U0A2tNYhM-unsplash.jpg"; // Same as Honey Almond
import AjwainCookiesImg from "./angelo-pantazis-2-U0A2tNYhM-unsplash.jpg"; // Same as Honey Almond
import ChocoChipsCookiesImg from "./angelo-pantazis-2-U0A2tNYhM-unsplash.jpg"; // Same as Honey Almond
import CustomThemeCakeImg from "../../images/Products/WhatsApp Image 2026-01-07 at 2.42.10 PM.jpeg"; // Placeholder
import ComboCakeImg from "../../images/Products/WhatsApp Image 2026-01-07 at 2.42.11 PM.jpeg"; // Placeholder
...
const categories = [
  ...
  "Combo Cakes",
  "Kids cakes",
  "customised cake", // Assuming this is an existing category you want to keep
  "Anniversary cakes",
  "Heartshape cakes",
  "Photo cakes",
  "chocolate cakes",
...
const products = [
  ...
  // New products from images/new products folder
  { id: 108, name: "New Product 1", category: "Cakes", price: "₹500", image: NewProduct1 },
  { id: 109, name: "New Product 2", category: "Cakes", price: "₹550", image: NewProduct2 },
  { id: 110, name: "New Product 3", category: "Cakes", price: "₹600", image: NewProduct3 },
  { id: 111, name: "New Product 4", category: "Cakes", price: "₹450", image: NewProduct4 },
  { id: 112, name: "New Product 5", category: "Cakes", price: "₹500", image: NewProduct5 },
  { id: 113, name: "New Product 6", category: "Cakes", price: "₹550", image: NewProduct6 },
  { id: 114, name: "New Product 7", category: "Cakes", price: "₹600", image: NewProduct7 },
  { id: 115, name: "New Product 8", category: "Cakes", price: "₹650", image: NewProduct8 },
  { id: 116, name: "New Product 9", category: "Cakes", price: "₹700", image: NewProduct9 },
  { id: 117, name: "New Product 10", category: "Cakes", price: "₹500", image: NewProduct10 },
  { id: 118, name: "New Product 11", category: "Cakes", price: "₹550", image: NewProduct11 },
  { id: 119, name: "New Product 12", category: "Cakes", price: "₹600", image: NewProduct12 },
  { id: 120, name: "New Product 13", category: "Cakes", price: "₹450", image: NewProduct13 },
  { id: 121, name: "New Product 14", category: "Cakes", price: "₹500", image: NewProduct14 },
  { id: 122, name: "New Product 15", category: "Cakes", price: "₹550", image: NewProduct15 },
  { id: 123, name: "New Product 16", category: "Cakes", price: "₹600", image: CakeImage1 },
  // 1) VANTO Cakes
  { id: 124, name: "Pineapple", category: "VANTO Cakes", price: "₹150", image: PineappleCakeImg },
  { id: 125, name: "Strawberry", category: "VANTO Cakes", price: "₹150", image: StrawberryCakeImg },
  { id: 126, name: "Butterscotch", category: "VANTO Cakes", price: "₹150", image: ButterscotchCakeImg },
  { id: 127, name: "Black Forest", category: "VANTO Cakes", price: "₹150", image: BlackForestCakeImg },
  { id: 128, name: "White Forest", category: "VANTO Cakes", price: "₹150", image: WhiteForestCakeImg },
  { id: 129, name: "Chocolate", category: "VANTO Cakes", price: "₹180", image: ChocolateCakeImg },
  { id: 130, name: "Customised VANTO Cakes", category: "Speciality Cakes", price: "Call/Email for price", image: CustomThemeCakeImg },
  
  // 2) Pastries
  { id: 131, name: "Pineapple Pastry", category: "Pastries", price: "₹50", image: PineapplePastryImg },
  { id: 132, name: "Strawberry Pastry", category: "Pastries", price: "₹50", image: StrawberryPastryImg },
  { id: 133, name: "Butterscotch Pastry", category: "Pastries", price: "₹50", image: ButterscotchPastryImg },
  { id: 134, name: "Blueberry Pastry", category: "Pastries", price: "₹70", image: BlueberryPastryImg },
  { id: 135, name: "Fruit Cocktail Pastry", category: "Pastries", price: "₹80", image: FruitCocktailPastryImg },
  { id: 136, name: "Pista Pastry", category: "Pastries", price: "₹80", image: PistaPastryImg },
  { id: 137, name: "Rasmalai Pastry", category: "Pastries", price: "₹80", image: RasmalaiPastryImg },
  { id: 138, name: "Moose Pastry", category: "Pastries", price: "₹80", image: MoosePastryImg },
  { id: 139, name: "Chocolate Pastry", category: "Pastries", price: "₹70", image: ChocolatePastryImg },
  { id: 140, name: "Truffle Pastry", category: "Pastries", price: "₹80", image: TrufflePastryImg },
  { id: 141, name: "White Truffle Pastry", category: "Pastries", price: "₹80", image: WhiteTrufflePastryImg },
  { id: 142, name: "Black Forest Pastry", category: "Pastries", price: "₹50", image: BlackForestPastryImg },
  { id: 143, name: "White Forest Pastry", category: "Pastries", price: "₹50", image: WhiteTrufflePastryImg },
  { id: 144, name: "Regular Celebration Pastry (mix flavors)", category: "Pastries", price: "₹40", image: RegularCelebrationPastryImg },

  // 3) Cheese Pastry
  { id: 145, name: "Lotus Biscoff Cheese Pastry", category: "Cheese Pastry", price: "₹80", image: LotusBiscoffCheesePastryImg },
  { id: 146, name: "Blueberry Cheese Pastry", category: "Cheese Pastry", price: "₹170", image: BlueberryCheesePastryImg },
  { id: 147, name: "Mango Cheese Pastry", category: "Cheese Pastry", price: "₹150", image: MangoCheesePastryImg },
  { id: 148, name: "Hazelnut Cheese Pastry", category: "Cheese Pastry", price: "₹160", image: HazelnutCheesePastryImg },

  // 4) Cheese Cakes
  { id: 149, name: "Lotus Biscoff Cheese Cake (500 gm)", category: "Cheese Cakes", price: "₹950", image: LotusBiscoffCheeseCakeImg },
  { id: 150, name: "Lotus Biscoff Cheese Cake (1 kg)", category: "Cheese Cakes", price: "₹1800", image: LotusBiscoffCheeseCakeImg },
  { id: 151, name: "Blueberry Cheese Cake (500 gm)", category: "Cheese Cakes", price: "₹850", image: BlueberryCheeseCakeImg },
  { id: 152, name: "Blueberry Cheese Cake (1 kg)", category: "Cheese Cakes", price: "₹1500", image: BlueberryCheeseCakeImg },
  { id: 153, name: "Mango Cheese Cake (500 gm)", category: "Cheese Cakes", price: "₹850", image: MangoCheeseCakeImg },
  { id: 154, name: "Mango Cheese Cake (1 kg)", category: "Cheese Cakes", price: "₹1500", image: MangoCheeseCakeImg },
  { id: 155, name: "Hazelnut Cheese Cake (500 gm)", category: "Cheese Cakes", price: "₹850", image: HazelnutCheeseCakeImg },
  { id: 156, name: "Hazelnut Cheese Cake (1 kg)", category: "Cheese Cakes", price: "₹1500", image: HazelnutCheeseCakeImg },

  // 5) Mini Cakes
  { id: 157, name: "Pista Mini Cake", category: "Mini Cakes", price: "₹100", image: PistaMiniCakeImg },
  { id: 158, name: "Biscoff Mini Cake", category: "Mini Cakes", price: "₹100", image: BiscoffMiniCakeImg },
  { id: 159, name: "Red Velvet Mini Cake", category: "Mini Cakes", price: "₹100", image: RedVelvetMiniCakeImg },

  // 6) Cakes (500g / 1kg / 300g Eggless)
  { id: 160, name: "Pineapple Cake (300g)", category: "Cakes", price: "₹300", image: PineappleCakeImg },
  { id: 161, name: "Pineapple Cake (500g)", category: "Cakes", price: "₹550", image: PineappleCakeImg },
  { id: 162, name: "Pineapple Cake (1kg)", category: "Cakes", price: "₹250", image: PineappleCakeImg, note: "Eggless available" },
  { id: 163, name: "Strawberry Cake (300g)", category: "Cakes", price: "₹300", image: StrawberryCakeImg },
  { id: 164, name: "Strawberry Cake (500g)", category: "Cakes", price: "₹550", image: StrawberryCakeImg },
  { id: 165, name: "Strawberry Cake (1kg)", category: "Cakes", price: "₹250", image: StrawberryCakeImg, note: "Eggless available" },
  { id: 166, name: "Butterscotch Cake (300g)", category: "Cakes", price: "₹300", image: ButterscotchCakeImg },
  { id: 167, name: "Butterscotch Cake (500g)", category: "Cakes", price: "₹550", image: ButterscotchCakeImg },
  { id: 168, name: "Butterscotch Cake (1kg)", category: "Cakes", price: "₹250", image: ButterscotchCakeImg, note: "Eggless available" },
  { id: 169, name: "White Forest Cake (300g)", category: "Cakes", price: "₹300", image: WhiteForestCakeImg },
  { id: 170, name: "White Forest Cake (500g)", category: "Cakes", price: "₹550", image: WhiteForestCakeImg },
  { id: 171, name: "White Forest Cake (1kg)", category: "Cakes", price: "₹250", image: WhiteForestCakeImg, note: "Eggless available" },
  { id: 172, name: "Black Forest Cake (300g)", category: "Cakes", price: "₹300", image: BlackForestCakeImg },
  { id: 173, name: "Black Forest Cake (500g)", category: "Cakes", price: "₹550", image: BlackForestCakeImg },
  { id: 174, name: "Black Forest Cake (1kg)", category: "Cakes", price: "₹250", image: BlackForestCakeImg, note: "Eggless available" },
  { id: 175, name: "Blueberry Cake (300g)", category: "Cakes", price: "₹400", image: BlueberryCheeseCakeImg },
  { id: 176, name: "Blueberry Cake (500g)", category: "Cakes", price: "₹750", image: BlueberryCheeseCakeImg },
  { id: 177, name: "Blueberry Cake (1kg)", category: "Cakes", price: "₹250", image: BlueberryCheeseCakeImg, note: "Eggless available" },
  { id: 178, name: "Blackcurrant Cake (300g)", category: "Cakes", price: "₹400", image: CakeImage14 },
  { id: 179, name: "Blackcurrant Cake (500g)", category: "Cakes", price: "₹750", image: CakeImage14 },
  { id: 180, name: "Blackcurrant Cake (1kg)", category: "Cakes", price: "₹250", image: CakeImage14, note: "Eggless available" },
  { id: 181, name: "Red Velvet Cake (300g)", category: "Cakes", price: "₹550", image: RedVelvetMiniCakeImg },
  { id: 182, name: "Red Velvet Cake (500g)", category: "Cakes", price: "₹1000", image: RedVelvetMiniCakeImg },
  { id: 183, name: "Red Velvet Cake (1kg)", category: "Cakes", price: "₹250", image: RedVelvetMiniCakeImg, note: "Eggless available" },
  { id: 184, name: "Rasmalai Cake (300g)", category: "Cakes", price: "₹400", image: RasmalaiPastryImg },
  { id: 185, name: "Rasmalai Cake (500g)", category: "Cakes", price: "₹750", image: RasmalaiPastryImg },
  { id: 186, name: "Rasmalai Cake (1kg)", category: "Cakes", price: "₹250", image: RasmalaiPastryImg, note: "Eggless available" },
  { id: 187, name: "Pista Cake (300g)", category: "Cakes", price: "₹400", image: PistaMiniCakeImg },
  { id: 188, name: "Pista Cake (500g)", category: "Cakes", price: "₹750", image: PistaMiniCakeImg },
  { id: 189, name: "Pista Cake (1kg)", category: "Cakes", price: "₹250", image: PistaMiniCakeImg, note: "Eggless available" },
  { id: 190, name: "Fruit Cocktail Cake (300g)", category: "Cakes", price: "₹400", image: FruitCocktailPastryImg },
  { id: 191, name: "Fruit Cocktail Cake (500g)", category: "Cakes", price: "₹750", image: FruitCocktailPastryImg },
  { id: 192, name: "Fruit Cocktail Cake (1kg)", category: "Cakes", price: "₹250", image: FruitCocktailPastryImg, note: "Eggless available" },
  { id: 193, name: "Chocolate Moose Cake (500g)", category: "Cakes", price: "₹600", image: MoosePastryImg },
  { id: 194, name: "Chocolate Moose Cake (1kg)", category: "Cakes", price: "₹1000", image: MoosePastryImg, note: "Eggless available" },
  { id: 195, name: "Chocolate Truffle Cake (500g)", category: "Cakes", price: "₹600", image: ChocolateTruffleBrownieImg },
  { id: 196, name: "Chocolate Truffle Cake (1kg)", category: "Cakes", price: "₹1000", image: ChocolateTruffleBrownieImg, note: "Eggless available" },
  { id: 197, name: "White Truffle Cake (500g)", category: "Cakes", price: "₹600", image: WhiteTrufflePastryImg },
  { id: 198, name: "White Truffle Cake (1kg)", category: "Cakes", price: "₹1000", image: WhiteTrufflePastryImg, note: "Eggless available" },
  { id: 199, name: "Kit Kat Cake (500g)", category: "Cakes", price: "₹700", image: CakeImage12 },
  { id: 200, name: "Kit Kat Cake (1kg)", category: "Cakes", price: "₹1300", image: CakeImage12, note: "Eggless available" },
  { id: 201, name: "Oreo Cake (500g)", category: "Cakes", price: "₹600", image: CakeImage13 },
  { id: 202, name: "Oreo Cake (1kg)", category: "Cakes", price: "₹1100", image: CakeImage13, note: "Eggless available" },
  { id: 203, name: "Brownie Cake (500g)", category: "Cakes", price: "₹1200", image: ChocolateTruffleBrownieImg },
  { id: 204, name: "Brownie Cake (1kg)", category: "Cakes", price: "₹2000", image: ChocolateTruffleBrownieImg, note: "Eggless available" },
  { id: 205, name: "Mango Cake (300g)", category: "Cakes", price: "₹350", image: MangoCheesePastryImg },
  { id: 206, name: "Mango Cake (500g)", category: "Cakes", price: "₹600", image: MangoCheesePastryImg },
  { id: 207, name: "Mango Cake (1kg)", category: "Cakes", price: "₹250", image: MangoCheesePastryImg, note: "Eggless available" },
  { id: 208, name: "Chocolate Cake (300g)", category: "Cakes", price: "₹400", image: ChocolateCakeImg },
  { id: 209, name: "Chocolate Cake (500g)", category: "Cakes", price: "₹700", image: ChocolateCakeImg },
  { id: 210, name: "Chocolate Cake (1kg)", category: "Cakes", price: "₹250", image: ChocolateCakeImg, note: "Eggless available" },

  // 7) Breads
  { id: 211, name: "Bread 400 gm", category: "Breads", price: "₹30", image: Bread400gmImg },
  { id: 212, name: "Bread 600 gm", category: "Breads", price: "₹40", image: Bread600gmImg },
  { id: 213, name: "Jumbo Bread 1kg", category: "Breads", price: "₹100", image: JumboBreadImg },
  { id: 214, name: "Pav 250 gm (6 pcs)", category: "Breads", price: "₹25", image: PavImg },
  { id: 215, name: "Burger Bun 250 gm (4 pcs)", category: "Breads", price: "₹25", image: BurgerBunImg },
  { id: 216, name: "Pav Bhaji Pav (4 pcs)", category: "Breads", price: "₹25", image: PavBhajiPavImg },
  { id: 217, name: "Masala Bun (4 pcs)", category: "Breads", price: "₹25", image: MasalaBunImg },
  { id: 218, name: "Pizza Base (per pcs)", category: "Breads", price: "₹20", image: PizzaBaseImg },

  // 8) Coffee
  { id: 219, name: "Hot Coffee (Regular)", category: "Coffee", price: "₹80", image: HotCoffeeImg },
  { id: 220, name: "Hot Coffee (Small)", category: "Coffee", price: "₹50", image: HotCoffeeImg },
  { id: 221, name: "Cold Coffee", category: "Coffee", price: "₹60", image: ColdCoffeeImg },
  { id: 222, name: "Cold Coffee with Ice Cream", category: "Coffee", price: "₹80", image: ColdCoffeeIceCreamImg },

  // 9) Patties
  { id: 223, name: "Chilli Paneer Pattie", category: "Patties", price: "₹40", image: ChilliPaneerPattieImg },
  { id: 224, name: "Aloo Pattie", category: "Patties", price: "₹30", image: AlooPattieImg },

  // 10) Snacks
  { id: 225, name: "Paneer Roll", category: "Snacks", price: "₹50", image: PaneerRollImg },
  { id: 226, name: "Paneer Kulcha", category: "Snacks", price: "₹50", image: PaneerKulchaImg },
  { id: 227, name: "Veggie Roll", category: "Snacks", price: "₹40", image: VeggieRollImg },
  { id: 228, name: "Cheese Roll", category: "Snacks", price: "₹70", image: CheeseRollImg },

  // 11) Cookies
  { id: 229, name: "Honey Almond Cookies", category: "Cookies", price: "₹60", image: HoneyAlmondCookiesImg },
  { id: 230, name: "Kaju Cookies", category: "Cookies", price: "₹60", image: KajuCookiesImg },
  { id: 231, name: "Badam Cookies", category: "Cookies", price: "₹60", image: BadamCookiesImg },
  { id: 232, name: "Jim Jam Cookies", category: "Cookies", price: "₹50", image: JimJamCookiesImg },
  { id: 233, name: "Nata Kata Cookies", category: "Cookies", price: "₹50", image: NataKataCookiesImg },
  { id: 234, name: "Jeera Cookies", category: "Cookies", price: "₹50", image: JeeraCookiesImg },
  { id: 235, name: "Ajwain Cookies", category: "Cookies", price: "₹50", image: AjwainCookiesImg },
  { id: 236, name: "Choco Chips Cookies", category: "Cookies", price: "₹60", image: ChocoChipsCookiesImg },

  // 12) Special Items
  { id: 237, name: "Chocolate Truffle Brownie", category: "Special Items", price: "₹120", image: ChocolateTruffleBrownieImg },
  { id: 238, name: "Brownie with Ice Cream", category: "Special Items", price: "₹140", image: BrownieWithIceCreamImg },
  { id: 239, name: "Croissant", category: "Special Items", price: "₹50", image: CroissantImg },
  { id: 240, name: "Donut", category: "Special Items", price: "₹60", image: DonutImg },
  { id: 241, name: "Cupcake Vanilla", category: "Special Items", price: "₹40", image: CupcakeVanillaImg },
  { id: 242, name: "Cupcake Chocolate", category: "Special Items", price: "₹40", image: CupcakeChocolateImg },
  { id: 243, name: "Truffle Cup", category: "Special Items", price: "₹40", image: TruffleCupImg },
  { id: 244, name: "Choco Lava", category: "Special Items", price: "₹40", image: ChocoLavaImg },

  // 13) New Categories
  { id: 245, name: "Custom Theme Cake", category: "Custom Cakes", price: "Call/Email for price", image: CustomThemeCakeImg },
  { id: 246, name: "Cake + Pastry + Snack Combo", category: "Combo Cakes", price: "Call/Email for price", image: ComboCakeImg },
];
export default function ProductPageDashboard() {
  const [cart, setCart] = useState([]);
  const [isSticky, setIsSticky] = useState(false);
  ...
  return (
    <div>
      <SEO 
        title={`${selectedCategory} - Celebration Bakers | Browse & Order Online`}
        description={`Browse our ${selectedCategory} collection at Celebration Bakers. Fresh ${selectedCategory.toLowerCase()} including cakes, pastries, breads, cookies, and more. Order online with fast delivery.`}
        keywords={`${selectedCategory}, celebration bakers, ${selectedCategory.toLowerCase()}, order online, bakery products, fresh ${selectedCategory.toLowerCase()}, online bakery`}
      />
      <Navbar isSticky={isSticky} menuOpen={menuOpen} toggleMenu={toggleMenu} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {filteredProducts.map((product) => (
              <div key={product.id} className="bg-white p-4 shadow rounded-lg">
                ...
                <h3 className="text-md font-semibold">{product.name}</h3>
                <p className="text-green-600 font-bold">{product.price}</p>
                {product.price === "Call/Email for price" ? (
                  <button 
                    className="mt-2 bg-blue-500 text-white py-1 px-3 rounded transition-all duration-300"
                    onClick={() => {
                      const slug = product.name.toLowerCase()
                        ...
                        .replace(/-+/g, '-')
                        .replace(/^-|-$/g, '');
                      navigate(`/products/special-order/${slug}`);
                    }}
                  >
                    View Details
                  </button>
