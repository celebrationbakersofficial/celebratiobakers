...
import CustomThemeCakeImg from "../Allproducts/images1/photo_2025-03-30_09-50-25.jpg"; // Using a generic image for custom cakes
import ComboCakeImg from "../Allproducts/images1/photo_2025-03-30_09-50-24.jpg"; // Using a generic image for combo cakes
...
export default function Specialitycakes() {
  ...
  return (
    <>
      <SEO 
        title="Speciality Cakes - Celebration Bakers | Custom Cakes & Theme Cakes"
        description="Explore our speciality cakes collection at Celebration Bakers. Custom theme cakes, birthday cakes, anniversary cakes, VANTO cakes, and more. Made-to-order for your special occasions. Call or email to order."
        keywords="speciality cakes, custom cakes, theme cakes, birthday cakes, anniversary cakes, VANTO cakes, customised cakes, celebration bakers, order custom cake, made to order cakes"
      />
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-2/3 text-left md:order-2">
            <p className="text-lg text-gray-600">
              ...
              <br /><br />
              Write to us with your customized theme cake requirements at - <a href="mailto:celebrationbakersofficial@gmail.com" style={{ color: '#9d4c5f' }}>celebrationbakersofficial@gmail.com</a>
            </p>
          </div>
