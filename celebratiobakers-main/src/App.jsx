...
const App = () => {
  ...
  return (
    ...
    <div >
            <SEO 
              title="Celebration Bakers - Fresh Cakes, Pastries, Breads & Bakery Items Online | Order Now"
              description="Celebration Bakers offers fresh cakes, pastries, breads, cookies, coffee, and specialty bakery items. Order online for birthday cakes, anniversary cakes, custom theme cakes, cheese cakes, VANTO cakes, and more. Fast delivery available."
              keywords="bakery, cakes, pastries, bread, cookies, birthday cake, anniversary cake, custom cake, theme cake, cheese cake, VANTO cake, online bakery, order cake online, fresh bakery, celebration bakers, bakery near me, cake delivery, pastry shop, bread bakery, coffee, snacks, patties"
            />
            {/* <div className="promo-banner">
        <p>
          <strong>Flat 10% OFF on the first order. </strong> <strong>Use Code:</strong>
...
<Header />
    ...
    <Route path="/products/special-order/:productName" element={<ProductPage />} />
